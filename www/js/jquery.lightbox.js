				...
				if (!plugin.lightbox) {
					$('body').append(
						'<div id="lightbox" style="display:none;">'+
							'<a href="#" class="lightbox-close lightbox-button"><i class="fa fa-compress"></i></a>' +
							'<div class="lightbox-nav">'+
								'<a href="#" class="lightbox-previous lightbox-button"><i class="fa fa-angle-left"></i></a>' +
								'<a href="#" class="lightbox-next lightbox-button"><i class="fa fa-angle-right"></i></a>' +
							'</div>' +
